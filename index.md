...
example, we will use one of two “all-in-one” functions:
...
![](reference/figures/README-all_in_one-1.png)
...
to add information about the experiments that are necessary for
...
and 2) estimating the visual angles from the subject’s perspective
...
![](reference/figures/README-motive_V_sf_pos-1.png)
